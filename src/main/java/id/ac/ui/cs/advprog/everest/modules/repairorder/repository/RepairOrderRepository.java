...
public interface RepairOrderRepository extends JpaRepository<RepairOrder, Long> {
    ...
    Optional<RepairOrder> findByCustomerId(@NotBlank @Size(max=100) UUID customerId);

    Optional<RepairOrder> findByTechnicianId(@NotBlank @Size(max=100) UUID technicianId);
}
